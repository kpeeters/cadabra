/* 
   ...
   $Id: tree_new.hh,v 1.2 2006/06/05 21:54:00 peekas Exp $
...
template <class T>
class five_fold_linked {
	public:
		typedef tree_node_<T> value_type;
		
};

template <class T>
class three_fold_linked {
	public:
};

template <class T, class tree_node_allocator = std::allocator<tree_node_<T> >, 
                   class nodestore = tree_node_<T> >
class tree {
	protected:
		typedef nodestore tree_node;
	public:
		...
		tree(const tree<T, tree_node_allocator, nodestore>&);
		~tree();
		void operator=(const tree<T, tree_node_allocator, nodestore>&);
...
//		iterator find_subtree(sibling_iterator, sibling_iterator, iterator from, iterator to, BinaryPredicate) const;
		...
		class iterator_base_less {
			public:
				bool operator()(const typename tree<T, tree_node_allocator, nodestore>::iterator_base& one,
									 const typename tree<T, tree_node_allocator, nodestore>::iterator_base& two) const
					{
	...
	private:
		...
		void copy_(const tree<T, tree_node_allocator, nodestore>& other);
		template <class StrictWeakOrdering>
		class compare_nodes {
			public:
...
//template <class T, class tree_node_allocator, class nodestore>
//class iterator_base_less {
//	public:
//		bool operator()(const typename tree<T, tree_node_allocator, nodestore>::iterator_base& one,
//						  const typename tree<T, tree_node_allocator, nodestore>::iterator_base& two) const
...
//template <class T, class tree_node_allocator, class nodestore>
//bool operator<(const typename tree<T, tree_node_allocator, nodestore>::iterator& one,
//					const typename tree<T, tree_node_allocator, nodestore>::iterator& two)
//	{
...
template <class T, class tree_node_allocator, class nodestore>
bool operator>(const typename tree<T, tree_node_allocator, nodestore>::iterator_base& one,
					const typename tree<T, tree_node_allocator, nodestore>::iterator_base& two)
	{
	if(one.node > two.node) return true;
	return false;
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::tree() 
	{
	head_initialise_();
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::tree(const T& x) 
	{
	head_initialise_();
	set_head(x);
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::tree(const iterator_base& other)
	{
	head_initialise_();
	set_head((*other));
	replace(begin(), other);
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::head_initialise_() 
   { 
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::operator=(const tree<T, tree_node_allocator, nodestore>& other)
	{
	copy_(other);
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::tree(const tree<T, tree_node_allocator, nodestore>& other)
	{
	head_initialise_();
	copy_(other);
	}
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::copy_(const tree<T, tree_node_allocator, nodestore>& other) 
	{
	clear();
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::clear()
	{
	if(head)
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::erase_children(const iterator_base& it)
	{
...
template <class T, class tree_node_allocator, class nodestore> 
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::erase(iter it)
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::pre_order_iterator tree<T, tree_node_allocator, nodestore>::begin() const
	{
	return pre_order_iterator(head->next_sibling);
	}

template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::pre_order_iterator tree<T, tree_node_allocator, nodestore>::end() const
	{
	return pre_order_iterator(feet);
	}

template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::post_order_iterator tree<T, tree_node_allocator, nodestore>::begin_post() const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::post_order_iterator tree<T, tree_node_allocator, nodestore>::end_post() const
	{
	return post_order_iterator(feet);
	}

template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator tree<T, tree_node_allocator, nodestore>::begin_fixed(const iterator_base& pos, unsigned int dp) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator tree<T, tree_node_allocator, nodestore>::end_fixed(const iterator_base& pos, unsigned int dp) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::begin(const iterator_base& pos) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::end(const iterator_base& pos) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter>
iter tree<T, tree_node_allocator, nodestore>::parent(iter position) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::previous_sibling(const iterator_base& position) const
	{
	assert(position.node!=0);
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::next_sibling(const iterator_base& position) const
	{
	assert(position.node!=0);
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter>
iter tree<T, tree_node_allocator, nodestore>::append_child(iter position)
 	{
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::append_child(iter position, const T& x)
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::append_child(iter position, iter other)
	{
	assert(position.node!=head);
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::append_children(iter position, sibling_iterator from, sibling_iterator to)
	{
	iter ret=from;
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::pre_order_iterator tree<T, tree_node_allocator, nodestore>::set_head(const T& x)
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::insert(iter position, const T& x)
	{
	if(position.node==0) {
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::insert(sibling_iterator position, const T& x)
	{
	tree_node* tmp = alloc_.allocate(1,0);
	constructor(&tmp->data(), x);
	tmp->first_child=0;
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::insert_after(iter position, const T& x)
	{
	tree_node* tmp = alloc_.allocate(1,0);
	constructor(&tmp->data(), x);
	tmp->first_child=0;
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::insert_subtree(iter position, const iterator_base& subtree)
	{
	// insert dummy
...
// template <class T, class tree_node_allocator, class nodestore>
// template <class iter>
// iter tree<T, tree_node_allocator, nodestore>::insert_subtree(sibling_iterator position, iter subtree)
// 	{
// 	// insert dummy
// 	iter it(insert(position, value_type()));
// 	// replace dummy with subtree
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::replace(iter position, const T& x)
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <class iter>
iter tree<T, tree_node_allocator, nodestore>::replace(iter position, const iterator_base& from)
	{
	assert(position.node!=head);
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::replace(
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter>
iter tree<T, tree_node_allocator, nodestore>::flatten(iter position)
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter>
iter tree<T, tree_node_allocator, nodestore>::reparent(iter position, sibling_iterator begin, sibling_iterator end)
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter> iter tree<T, tree_node_allocator, nodestore>::reparent(iter position, iter from)
	{
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::merge(sibling_iterator to1,   sibling_iterator to2,
...
template <class T, class tree_node_allocator, class nodestore>
template <class StrictWeakOrdering> 
bool tree<T, tree_node_allocator, nodestore>::compare_nodes<StrictWeakOrdering>::operator()(const tree_node *a, 
																											const tree_node *b)
	{
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::sort(sibling_iterator from, sibling_iterator to, bool deep)
	{
	std::less<T> comp;
...
template <class T, class tree_node_allocator, class nodestore>
template <class StrictWeakOrdering>
void tree<T, tree_node_allocator, nodestore>::sort(sibling_iterator from, sibling_iterator to, 
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter>
bool tree<T, tree_node_allocator, nodestore>::equal(const iter& one_, const iter& two, const iter& three_) const
	{
	std::equal_to<T> comp;
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter>
bool tree<T, tree_node_allocator, nodestore>::equal_subtree(const iter& one_, const iter& two_) const
	{
	std::equal_to<T> comp;
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter, class BinaryPredicate>
bool tree<T, tree_node_allocator, nodestore>::equal(const iter& one_, const iter& two, const iter& three_, BinaryPredicate fun) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
template <typename iter, class BinaryPredicate>
bool tree<T, tree_node_allocator, nodestore>::equal_subtree(const iter& one_, const iter& two_, BinaryPredicate fun) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore> tree<T, tree_node_allocator, nodestore>::subtree(sibling_iterator from, sibling_iterator to) const
	{
	tree tmp;
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::subtree(tree& tmp, sibling_iterator from, sibling_iterator to) const
	{
	tmp.set_head(value_type());
	tmp.replace(tmp.begin(), tmp.end(), from, to);
	}
...
template <class T, class tree_node_allocator, class nodestore>
int tree<T, tree_node_allocator, nodestore>::size() const
	{
	int i=0;
...
template <class T, class tree_node_allocator, class nodestore>
bool tree<T, tree_node_allocator, nodestore>::empty() const
	{
	pre_order_iterator it=begin(), eit=end();
	return (it==eit);
	}
...
template <class T, class tree_node_allocator, class nodestore>
int tree<T, tree_node_allocator, nodestore>::depth(const iterator_base& it) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
unsigned int tree<T, tree_node_allocator, nodestore>::number_of_children(const iterator_base& it) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
unsigned int tree<T, tree_node_allocator, nodestore>::number_of_siblings(const iterator_base& it) const
	{
	tree_node *pos=it.node;
	unsigned int ret=1;
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::swap(sibling_iterator it)
	{
...
// template <class BinaryPredicate>
// tree<T, tree_node_allocator, nodestore>::iterator tree<T, tree_node_allocator, nodestore>::find_subtree(
...
template <class T, class tree_node_allocator, class nodestore>
bool tree<T, tree_node_allocator, nodestore>::is_in_subtree(const iterator_base& it, const iterator_base& begin, 
																 const iterator_base& end) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
bool tree<T, tree_node_allocator, nodestore>::is_valid(const iterator_base& it) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
unsigned int tree<T, tree_node_allocator, nodestore>::index(sibling_iterator it) const
	{
	unsigned int ind=0;
	if(it.node->parent==0) {
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::child(const iterator_base& it, unsigned int num) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::iterator_base::iterator_base()
	: node(0), skip_current_children_(false)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::iterator_base::iterator_base(tree_node *tn)
	: node(tn), skip_current_children_(false)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
T& tree<T, tree_node_allocator, nodestore>::iterator_base::operator*() const
	{
	return node->data();
	}
...
template <class T, class tree_node_allocator, class nodestore>
bool tree<T, tree_node_allocator, nodestore>::post_order_iterator::operator!=(const post_order_iterator& other) const
	{
...
template <class T, class tree_node_allocator, class nodestore>
bool tree<T, tree_node_allocator, nodestore>::pre_order_iterator::operator!=(const pre_order_iterator& other) const
	{
	if(other.node!=this->node) return true;
	else return false;
	}
...
template <class T, class tree_node_allocator, class nodestore>
bool tree<T, tree_node_allocator, nodestore>::sibling_iterator::operator!=(const sibling_iterator& other) const
	{
	if(other.node!=this->node) return true;
	else return false;
	}
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::iterator_base::begin() const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator tree<T, tree_node_allocator, nodestore>::iterator_base::end() const
	{
	sibling_iterator ret(0);
	ret.parent_=node;
	return ret;
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::iterator_base::skip_children()
	{
	skip_current_children_=true;
	}

template <class T, class tree_node_allocator, class nodestore>
unsigned int tree<T, tree_node_allocator, nodestore>::iterator_base::number_of_children() const
	{
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::pre_order_iterator::pre_order_iterator() 
	: iterator_base(0)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::pre_order_iterator::pre_order_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::pre_order_iterator::pre_order_iterator(const iterator_base &other)
	: iterator_base(other.node)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::pre_order_iterator::pre_order_iterator(const sibling_iterator& other)
	: iterator_base(other.node)
	{
	if(this->node==0) {
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::pre_order_iterator& tree<T, tree_node_allocator, nodestore>::pre_order_iterator::operator++()
	{
	assert(this->node!=0);
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::pre_order_iterator& tree<T, tree_node_allocator, nodestore>::pre_order_iterator::operator++(int n)
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::pre_order_iterator& tree<T, tree_node_allocator, nodestore>::pre_order_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::post_order_iterator::post_order_iterator() 
	: iterator_base(0)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::post_order_iterator::post_order_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::post_order_iterator::post_order_iterator(const iterator_base &other)
	: iterator_base(other.node)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::post_order_iterator::post_order_iterator(const sibling_iterator& other)
	: iterator_base(other.node)
	{
	if(this->node==0) {
		if(other.range_last()!=0)
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::post_order_iterator& tree<T, tree_node_allocator, nodestore>::post_order_iterator::operator++()
	{
	assert(this->node!=0);
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::post_order_iterator& tree<T, tree_node_allocator, nodestore>::post_order_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::post_order_iterator& tree<T, tree_node_allocator, nodestore>::post_order_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::post_order_iterator::descend_all()
	{
	assert(this->node!=0);
	while(this->node->first_child)
		this->node=this->node->first_child;
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::fixed_depth_iterator()
	: iterator_base()
	{
	set_first_parent_();
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::fixed_depth_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	set_first_parent_();
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::fixed_depth_iterator(const iterator_base& other)
	: iterator_base(other.node)
	{
	set_first_parent_();
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::fixed_depth_iterator(const sibling_iterator& other)
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::fixed_depth_iterator(const fixed_depth_iterator& other)
	: iterator_base(other.node), first_parent_(other.first_parent_)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::set_first_parent_()
	{
...
template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::find_leftmost_parent_()
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator& tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::operator++()
	{
	assert(this->node!=0);
	if(this->node->next_sibling!=0) {
		this->node=this->node->next_sibling;
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator& tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator& tree<T, tree_node_allocator, nodestore>::fixed_depth_iterator::operator-=(unsigned int num)
	{
	while(num>0) {
		--(*this);
		--(num);
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::sibling_iterator::sibling_iterator() 
	: iterator_base()
	{
	set_parent_();
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::sibling_iterator::sibling_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	set_parent_();
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::sibling_iterator::sibling_iterator(const iterator_base& other)
	: iterator_base(other.node)
	{
	set_parent_();
	}
...
template <class T, class tree_node_allocator, class nodestore>
tree<T, tree_node_allocator, nodestore>::sibling_iterator::sibling_iterator(const sibling_iterator& other)
	: iterator_base(other), parent_(other.parent_)
	{
	}

template <class T, class tree_node_allocator, class nodestore>
void tree<T, tree_node_allocator, nodestore>::sibling_iterator::set_parent_()
	{
	parent_=0;
	if(this->node==0) return;
	if(this->node->parent!=0)
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator& tree<T, tree_node_allocator, nodestore>::sibling_iterator::operator++()
	{
	if(this->node)
		this->node=this->node->next_sibling;
	return *this;
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator& tree<T, tree_node_allocator, nodestore>::sibling_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::sibling_iterator& tree<T, tree_node_allocator, nodestore>::sibling_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::tree_node *tree<T, tree_node_allocator, nodestore>::sibling_iterator::range_first() const
	{
...
template <class T, class tree_node_allocator, class nodestore>
typename tree<T, tree_node_allocator, nodestore>::tree_node *tree<T, tree_node_allocator, nodestore>::sibling_iterator::range_last() const
	{
