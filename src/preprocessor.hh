/* 
   ...
   $Id: preprocessor.hh,v 1.34 2007/06/19 18:06:57 peekas Exp $
...
#ifndef preprocessor_hh_
#define preprocessor_hh_

#include <iostream>
#include <string>
#include <vector>

enum { tok_arrow=0xac, tok_unequals=0xad, tok_wedge=0xae, tok_pow=0xaf, tok_set_option=0xb0, tok_declare=0xb1 };
