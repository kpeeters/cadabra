/* 
   ...
   $Id: window.hh,v 1.80 2008/06/22 12:50:43 peekas Exp $
...
const double  millimeter_per_inch = 25.4;
...
//		std::vector<Gtk::RefPtr<Gtk::Button> > buttons;
...
//DataCell::cell_t, const std::string&, bool tex_hidden=false,
	...
	private:
		...
		std::vector<CadabraHelp *>    helpwindows;
...
//		Gtk::Menu        menu_file, menu_edit, menu_view, menu_help;
		...
		enum parse_mode_t         { m_status, m_eqno, m_eq, m_property, m_algorithm,
											 m_discard, m_comment, m_error,
		                            m_progress, m_plain };
		std::vector<parse_mode_t> parse_mode;
		std::string               eqno, eq, status, progress, plain, algorithm, property;
...
//		std::set<std::string>     all_algorithms, all_properties;
		...
		static const unsigned int autocomplete_strings_len=50;
