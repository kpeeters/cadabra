\cdbproperty{EpsilonTensor}{{\it metric={\sf metric name}, delta={\sf
...
\subsprop{Metric} (so that the signature can be extracted) or a
\subsprop{KroneckerDelta} (so that the product of two epsilon tensors
can be written in terms of KroneckerDeltas, see the
\subscommand{epsprod2gendelta} command). When the indices are in
